...
class plgSystemMyJspaceInstallerScript {
	protected $minimumJoomlaVersion = '3.9.0';
	protected $component = 'com_myjspace';
	protected $minimumComponentVersion = '2.6.0';
	...
	public function preflight($type, $parent)
	{
		...
		if (version_compare($componentVersion, $this->minimumComponentVersion, 'lt')) { // Check for component compatibility
			JFactory::getApplication()->enqueueMessage('You need at least '.$this->$component.' '.$componentVersion.' to install this plugin', 'error');
			return false;
		}
