                    ...
                    foreach( $xml->files->admin->filename as $file)
                    {
                        if( isset($file['type']) and $file['type']=='javascript' )
                        {
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addScript(    JURI::root(true).'/modules/mod_portfolio_gallery_image_beautiful/tmpl/'.$folder.'/'.$file );
                            }
                        }  
                        ...
                        if( isset($file['type']) and $file['type']=='stylesheet' ){
                            ...
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addStyleSheet( JURI::root(true).'/modules/mod_portfolio_gallery_image_beautiful/tmpl/'.$folder.'/'.$file );
                            }
                        }
                    }
                }
